using FPTJOBSv2.Common.Base;
using FPTJOBSv2.Common.Constant;
using System;
using System.IO;
using System.Net;
...
namespace FPTJOBSv2.Common.Utilities
{
    public class HttpUtilities
    {
        private static string language = Translators.LanguageSelected() == Translators.LANGUAGE_ENGLISH ? "en-US" : "vi-VN";
        /// <summary>
